...
| `lunatv/` | LunaTV — a separate personal-cinema / live TV / media PWA, deployed on its own to GitHub Pages. See `lunatv/README.md`. Not part of the Backrooms build or its CI. |
