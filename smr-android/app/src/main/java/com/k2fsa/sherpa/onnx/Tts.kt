...
//
// Vendored, unmodified, from k2-fsa/sherpa-onnx (Apache 2.0):
// https://github.com/k2-fsa/sherpa-onnx/blob/master/sherpa-onnx/kotlin-api/Tts.kt
//
// Upstream does not publish this Kotlin API as a Maven artifact -- it's designed to be
// compiled directly into the consuming app, paired with the prebuilt native .so libraries
// from a GitHub release (fetched by the fetchSherpaOnnxNativeLibs Gradle task in
// app/build.gradle.kts). See tts/KokoroTtsEngine.kt for the code that uses this class.
